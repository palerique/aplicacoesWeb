...
<body>
	...
	<form id="cadastroform" method="post" action="cliente">
		...
		<input type="hidden" name="acao" value="salvarOuEditar" />
		...
		<input type="text" id="nome" name="nome" required placeholder="Nome da Empresa"
			tabindex="1" value="${cliente.nome}" />

		<!-- private String cnpj; -->
		<p>
			<label for="cnpj">CNPJ</label>
		</p>
		<input type="text" id="cnpj" name="cnpj" required placeholder="99999999/0001"
			tabindex="2" value="${cliente.cnpj}" />

		<!-- private String Contato; -->
		<p>
			<label for="contato">Contato</label>
		</p>
		<input type="text" id=contato name=contato required placeholder="Contato"
			tabindex="3" value="${cliente.contato}" />
		...
		<input type="text" id=endereco name=endereco required placeholder="Endereço"
			tabindex="4" value="${cliente.endereco}" />
		...
		<input type="text" id="bairro" name="bairro" required placeholder="Bairro"
			tabindex="5" value="${cliente.bairro}" />
		...
		<input type="text" id="municipio" name="municipio" required
			placeholder="Município" tabindex="6" value="${cliente.municipio}" />
		...
		<input type="text" id="estado" name="estado" placeholder="Estado" required
			tabindex="7" value="${cliente.estado}" />
		...
		<input type="text" id="telefone" name="telefone" required
			placeholder="Telefone" tabindex="8" value="${cliente.telefone}" />
		...
		<input type="text" id="homepage" name="homepage"
			placeholder="www.paginadaempresa.com.br" tabindex="9"
		...
		<input type="text" id="quantidadeEmpregados"
			...
			tabindex="10" value="${cliente.quantidadeEmpregados}" />

		<p>
			<input name="submit" type="submit" id="submit" tabindex="11"
				value="Enviar" />
		</p>
